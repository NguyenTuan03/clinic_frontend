...
export function Badge({ status, className = "" }: BadgeProps) {
  const styles = {
    ...
    [AppointmentStatus.COMPLETED]: "bg-emerald-50 text-emerald-700 border-emerald-200/60 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20",
